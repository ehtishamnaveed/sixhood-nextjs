    ...
    >
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-16 lg:gap-20 items-start">
          ...
          <div className="why-left-content lg:sticky lg:top-32 lg:self-start space-y-8">
            <div>
              ...
              <h2 className="text-[36px] sm:text-[46px] lg:text-[54px] font-black leading-[1.04] tracking-[-0.03em] text-white mb-5">
                Creative partnership
                <br />
                <span className="text-aurora">grounded in craft.</span>
              </h2>
              <p className="text-[16px] sm:text-[17px] leading-[1.75] text-text-secondary">
            ...
            {/* Credibility Metric Badge */}
            <div className="p-6 rounded-2xl glass-panel border-white/5 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#a7f3d0]/10 flex items-center justify-center text-[#a7f3d0]">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <div className="text-[20px] font-bold text-white tracking-tight">98% Client Retention</div>
                  <div className="text-[12px] text-text-muted">Over a decade of enduring client trust</div>
                </div>
              </div>

              <div className="pt-4 border-t border-white/5 flex items-center justify-between text-[12px] text-text-secondary">
                <span>Studio Base</span>
                <span className="font-medium text-white">Toronto, Ontario, Canada</span>
              </div>
            </div>
            ...
            <a
              href="#contact"
              className="btn-aurora text-[13px] uppercase tracking-wider font-bold px-7 py-3.5 inline-flex items-center gap-2"
            >
          ...
          <div className="space-y-6">
            {principles.map((item) => (
              <div
                key={item.num}
                className="why-principle-card group p-8 rounded-2xl glass-panel border-white/5 hover:border-white/20 transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-start gap-6">
                  <div className="text-[32px] sm:text-[40px] font-black font-mono text-white/20 group-hover:text-aurora transition-colors duration-300 select-none">
                    {item.num}
                  </div>
